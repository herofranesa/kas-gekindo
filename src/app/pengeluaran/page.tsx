...
export default function PengeluaranPage() {
  ...
  async function fetchData() {
    try {
      let url = "/api/kas?tipe=pengeluaran";
      ...
      setData(json.data || []);
      setTotal(json.totalPengeluaran || 0);
    } catch (err) {
      console.error(err);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 p-4 lg:p-8 pt-16 lg:pt-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <a
              href={`/api/export/csv?tipe=pengeluaran${startDate ? `&startDate=${startDate}` : ""}${endDate ? `&endDate=${endDate}` : ""}`}
            ...
            <a
              href={`/api/export/excel?tipe=pengeluaran${startDate ? `&startDate=${startDate}` : ""}${endDate ? `&endDate=${endDate}` : ""}`}
            ...
            <a
              href={`/api/export/pdf?tipe=pengeluaran${startDate ? `&startDate=${startDate}` : ""}${endDate ? `&endDate=${endDate}` : ""}`}
      ...
      <Modal
        ...
        title={editItem ? "Edit Pengeluaran" : "Tambah Pengeluaran"}
      >
        <FormKas
          tipe="pengeluaran"
